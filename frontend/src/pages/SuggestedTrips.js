...
function SuggestedTrips() {
  ...
  useEffect(() => {
    // NOTE: The URL MUST match your FastAPI backend URL and endpoint
    const API_URL = 'http://127.0.0.1:8000/suggested-trips';
    ...
    const fetchTrips = async () => {
      try {
        ...
        // Show a user-friendly error message if the backend is down
        setError('Could not load trips. Please ensure the FastAPI server is running.');
